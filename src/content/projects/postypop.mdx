...
Shipping a SaaS in public teaches you that the LLM is the easy part. The actual work is OAuth flows, webhook idempotency, abuse prevention, and the unglamorous middle layer that keeps a customer from rage-quitting on a Sunday morning.
