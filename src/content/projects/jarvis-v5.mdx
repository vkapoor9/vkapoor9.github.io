...
- **Eight role-scoped agents.** General, coding, research, homelab, devops, content, finance, kids. Each is declared as a YAML manifest with its own toolset, memory scope, and permission ceiling.
