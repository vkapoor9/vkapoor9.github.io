...
**Conversion.** A separate pipeline view tracks each lead through its lifecycle: first contact, follow-up, qualification, and outcome, so nothing stalls silently in the funnel.
