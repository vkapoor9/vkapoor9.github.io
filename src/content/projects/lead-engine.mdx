...
**Conversion.** A separate clients view tracks signed engagements through their lifecycle: discovery call, proposal sent, contract signed, deliverables, retainer billing. Pricing tiers and tier-aware proposal templates live inside the dashboard so quotes go out consistent.
